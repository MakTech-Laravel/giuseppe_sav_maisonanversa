...
export function HomeProduct() {
    ...
    return (
        <Section tone="cream2">
            <Wrap>
                <div className="grid items-center gap-10 ma-lg:grid-cols-[1fr_1.3fr_1fr] ma-lg:gap-15 md:grid-cols-2">
                    <Reveal>
                    ...
                    <Reveal className="hidden ma-lg:block">
                        <div className="border border-gold/25 px-6 py-8 text-center">
