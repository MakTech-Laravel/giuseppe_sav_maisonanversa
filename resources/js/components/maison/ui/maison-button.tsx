...
const maisonButtonVariants = cva(
    'inline-flex min-h-11 items-center justify-center gap-3 font-sans uppercase transition-all focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold disabled:pointer-events-none disabled:opacity-50',
    {
        variants: {
            variant: {
