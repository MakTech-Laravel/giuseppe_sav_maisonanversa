...
export function CommunityCourts() {
    ...
    return (
        <Wrap className="grid items-start gap-12 px-6 py-12 md:px-10 lg:grid-cols-[1fr_420px] lg:px-20">
            <div className="relative aspect-16/10 overflow-hidden border border-gold/10 bg-linear-to-br from-[#1A2E22] to-[#0F1A14]">
                <div
                    aria-hidden="true"
                ...
                {COURT_PINS.map((pin) => (
                    <button
                        key={pin.id}
                        type="button"
                        onClick={() => setHighlightedCourt(pin.id)}
            ...
            <div>
                ...
                {COURT_CARDS.map((court) => (
                    <article
                        ...
                        id={`court-${court.id}`}
                        className={cn(
                            'mb-3 border bg-cream2 p-6 transition-colors hover:border-gold/35',
                    ...
                    >
                        <div className="mb-2.5 flex items-start justify-between">
                            ...
                            <div
                                className={cn(
                                    'border px-2.5 py-1 font-sans text-[9px] tracking-[0.15em] uppercase',
                                    court.statusComing
