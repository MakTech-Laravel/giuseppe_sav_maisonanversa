...
import { updateEmailPreferences } from '@/actions/App/Http/Controllers/Member/DashboardController';
import {
    MemberPageHeader,
    MemberPanel,
    MemberSectionTitle,
...
export default function MemberEmailPreferences({
    preferences,
}: {
    ...
    const form = useForm(
        updateEmailPreferences(wayfinderLocale()),
        preferences,
    );
    ...
    return (
        <>
            <Head title={t('E-mailvoorkeuren')} />
            <MemberPageHeader
                eyebrow={t('De Heritage Letter')}
                title={t('E-mailvoorkeuren')}
                description={t(
